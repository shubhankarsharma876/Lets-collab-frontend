        ...
        <div>
            <Form {...form}>
                <form className='space-y-5' onSubmit={form.handleSubmit(onSubmit)}>
                    ...
                    <FormField control={form.control}
                        ...
                        render={({ field }) => <FormItem>
                            ...
                            <div className='flex gap-1 flex-wrap'>
                                {field.value.map((item) => <div key={item} onClick={() => handleTagsChange(item)} className='cursor-pointer flex rounded-full items-center border px-4 gap-2 py-1'>
                    ...
                    <DialogClose>
                        {false ? (<div><p>Free 3 projects! Try our plans...</p></div>) :
